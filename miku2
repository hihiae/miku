...
function Tween(P1)
    ...
    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart.TweenInfo.new(Distance / Speed, Emun.EasingStyle.Linear), {
    CFrame = P1
}):Play()
...
if Distance < 25 then
    ...
    game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidRootPart,TweenInfo.new(Distance / Speed, Emun.EasingStyle.Linear), {CFrame = Pos}):Play()
end
...
function BTP(P1)
    game.Players.LocalPlayer.Character.Head:Destory()
...
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(
        function()
        if _G.TeleportToKitsune or _G.OneClick or _G.AutoFactoryByMe or _G.TeleportEmberTemplate or
...
local Window = OrionLib:MakeWindow({Name = "Miku Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Miku Hub"})

local CL= Window:MakeTab({
    Name = "Main",
    Icon = "rbxassetid://4483345998",
    PremiumOnly = false
})

local Section = CL:AddSection({
    Name = "Auto Farm Level"
})


CL:AddParagraph("Main Farm","Click to Box to Farm, I ready update new mob farm!.")

ToggleFarm = CL:AddToggle({
Name = "Auto Farm",
Default = false,
Flag = "LevelFarm",
Save = true,
